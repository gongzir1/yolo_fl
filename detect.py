...
@torch.no_grad()
def run(
    # weights=ROOT / "src/weights-g/best.pt",  # model.pt path(s)
    weights=ROOT / "runs/train/exp-client2-epoch2-r3-1/weights/best.pt",
    source=ROOT / "data/datasets/images",  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        # default=ROOT / "src/weights-g/best.pt",
        default=ROOT /"runs/train/exp60/weights/best_g.pt",
        help="model path(s)",
    )
    parser.add_argument(
        "--source",
        type=str,
        default=ROOT / "data/datasets/images",
