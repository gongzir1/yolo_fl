"""
This file trains a yolo model without a federated communication. 
It is a centralizated approach.
"""
...
def main(opt) -> None:
    ...
    # Configure logger
    model = creation_of_the_model(opt=opt)

    train_handler(model=model, opt=opt)
