...
class Server:
    ...
    def __init__(
        ...
        self.save_file = "weights-g.pt"  # weights dir
    ...
    def fit(self, num_rounds: int) -> History:
        ...
        for current_round in range(1, num_rounds + 2):
        ...
        # w = save_dir / "weights-g"  # weights dir
        # w.mkdir(parents=True, exist_ok=True)
        # with open("src/params/" + self.save_file, "wb") as f:
        #    pickle.dump(self.parameters, f)

        # ckpt = torch.load(attempt_download(self.parameters), map_location=map_location)  # load
        # exclude = (
        ...
        # }
        # save_dir = ROOT
        # w = ROOT / "weights-g"  # weights dir
        # w.mkdir(parents=True, exist_ok=True)  # make dir
        # last, best = w / "last.pt", w / "best.pt"
        # #
        # # ckpt = self.parameters
        ...
        log(INFO, "fedAvg time: %s", elapsed)
